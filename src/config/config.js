...
BackendConfig.modelEndpoint = `${BackendConfig.backEndApi}/${BackendConfig.apiVersion}/model`; // POST добавляет новую карту, проверяет лимиты пользователя, GET получит модели по критериям
